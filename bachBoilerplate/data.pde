...
// The Prelude-class contains the pure musical data of the "Prelude in C".
// Modify dataConversion.pde to bring it into your favourite shape
...
// The notes – compressed to one octave
  ...
  int[] arp = {
    ...
    // TO DO
    // Intervals for decoration like 2, 4, 7 or 9, based on the root of the chord

    int[] chordsDecorativeIntervalsNumbers = {
        // "C",
        // "Dm7",
        // "G7",
        // "C",
